...
#define NL_TORCHLIGHT_INTENSITY 0.95  // 0.5 weak ~ 3.0 bright
...
#define NL_NETHER_AMBIENT vec3(2.0,1.16,0.89)
#define NL_END_AMBIENT    vec3(0.98,0.25,1.3)

/* Sun/moon light color */
#define NL_DAWN_SUNLIGHT_COL   vec3(1.0,0.4,0.1)
#define NL_NOON_SUNLIGHT_COL   vec3(0.9,0.9,0.9)
#define NL_NIGHT_MOONLIGHT_COL vec3(0.01,0.03,0.2)*0.2

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.0, 0.7333, 0.3451)
#define NL_UNDERWATER_TORCH_COL vec3(0.9,0.92,0.98)
#define NL_NETHER_TORCH_COL     vec3(1.0,0.22,0.22)
#define NL_END_TORCH_COL        vec3(1.0,0.5,1.0)
...
#define NL_DAWN_HORIZON_COL  vec3(3.0,1.0,0.0)
#define NL_DAWN_EDGE_COL     vec3(3.0,1.0,0.0)

#define NL_DAY_ZENITH_COL    vec3(0.29,0.5,1.0)
#define NL_DAY_HORIZON_COL   vec3(0.6863, 0.8431, 1.0)
#define NL_DAY_EDGE_COL      vec3(0.6863, 0.8431, 1.0)
...
#define NL_RAIN_ZENITH_COL   vec3(0.3,0.3,0.3)
...
#define NL_UNDERWATER_TINT vec3(0.38, 0.6, 1.0) // fog tint color when underwater
...
#define NL_CLOUD2_VELOCITY 1.15             // 0.0 static ~ 4.0 very fast
...
#define NL_CLOUD2_LAYER2_RAIN_THICKNESS 3.8     // 0.7 slim ~ 5.0 fat
//#define NL_CLOUD2_LAYER2_STEPS 3                // 3 low quality ~ 16 high quality
#define NL_CLOUD2_LAYER2_SCALE vec2(0.044, 0.044) // 0.003 large ~ 0.3 tiny
...
#define NL_SHOOTING_STAR_DELAY 1.5 // 0.0 no delay ~ 100.0 long time (100 secs)
...
#define NL_CHUNK_LOAD_ANIM 80.0 // [toggle] -600.0 fall from top ~ 600.0 rise from bottom

/* Sun/Moon */
#define NL_SUN_SIZE  1.0           // 0.3 tiny ~ 4.0 massive
#define NL_MOON_SIZE 1.6           // 0.3 tiny ~ 4.0 massive
...
#ifdef RAINBOW
  #define NL_RAINBOW 0.5
#endif

#ifdef NIGHT_VISION
 #undef NL_MIN_LIGHTING_BOOST
 #define NL_MIN_LIGHTING_BOOST 4.0
#endif
